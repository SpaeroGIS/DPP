...
namespace MilSpace.GeoCalculator.BusinessLogic.ReferenceData
{
    public static class Constants
    {
        ...
        new ProjectionsModel(
                             new CoordinateSystemModel((int)esriSRProjCSType.esriSRProjCS_WGS1984UTM_35N, 24.000, 0.000, "UTM Zone 35N"),
                             new CoordinateSystemModel((int)esriSRProjCSType.esriSRProjCS_Pulkovo1942GK_5N, 24.000, 45.180, "GK Zone 5N"),
                             new CoordinateSystemModel(Constants.Ukraine2000ID[2], 24.000, 45.100, "GK Zone 5")),
        new ProjectionsModel(
                             new CoordinateSystemModel((int)esriSRProjCSType.esriSRProjCS_WGS1984UTM_36N, 30.000, 0.000, "UTM Zone 36N"),
                             new CoordinateSystemModel((int)esriSRProjCSType.esriSRProjCS_Pulkovo1942GK_6N, 30.000, 44.330, "GK Zone 6N"),
                             new CoordinateSystemModel(Constants.Ukraine2000ID[3], 30.000, 43.190, "GK Zone 6")),
        new ProjectionsModel(
                             new CoordinateSystemModel((int)esriSRProjCSType.esriSRProjCS_WGS1984UTM_37N, 36.000, 0.000, "UTM Zone 37N"),
                             new CoordinateSystemModel((int)esriSRProjCSType.esriSRProjCS_Pulkovo1942GK_7N, 36.000, 41.430, "GK Zone 7N"),
                             new CoordinateSystemModel(Constants.Ukraine2000ID[4], 36.000, 43.430, "GK Zone 7"))};
